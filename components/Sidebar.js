    ...
    <div className="hidden sm:flex flex-col p-2 xl:items-start fixed h-full ml-24">
      ...
      {session ? (
        <>
          ...
          {/* mini-profile */}
          <div className="hoverEffect text-gray-700 flex items-center justify-center xl:justify-start mt-auto space-x-0.5">
            <img
              onClick={signOut}
        ...
        <button
          onClick={signIn}
          className="bg-blue-400 text-white rounded-full w-150 h-11 px-10 font-bold shadow-md hover:brightness-95 text-lg hidden xl:inline "
        >
          {" "}
          Sign In
        </button>
